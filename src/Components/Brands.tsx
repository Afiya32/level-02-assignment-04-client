...
const Brands = () => {
  ...
  return (
    <div className="my-8">
    <h2 className="text-3xl font-semibold text-center mb-6">World Famous Brands</h2>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      {brands.map((brand, index) => (
        <div key={index} className="flex flex-col items-center p-4 bg-white shadow rounded">
